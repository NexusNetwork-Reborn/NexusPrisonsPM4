...
class UnmuteCommand extends Command {
    ...
    public function __construct() {
        parent::__construct("unmute", "Relieve a player from a mute", "/unmute <player>");
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): void {
        ...
        $this->getCore()->getGameManager()->getBOOPManager()->relieve($this->getCore()->getGameManager()->getBOOPManager()->getMute($name), $sender->getName());
    }
}