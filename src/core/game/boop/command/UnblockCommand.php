...
class UnblockCommand extends Command {
    ...
    public function __construct() {
        parent::__construct("unblock", "Relieve a player from a block", "/unblock <player>");
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): void {
        ...
        $this->getCore()->getGameManager()->getBOOPManager()->relieve($this->getCore()->getGameManager()->getBOOPManager()->getBlock($name), $sender->getName());
    }
}