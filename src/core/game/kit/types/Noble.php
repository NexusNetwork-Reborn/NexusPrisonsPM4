...
class Noble extends Kit {

    /**
     * Archer constructor.
     */
    public function __construct() {
        parent::__construct("Plutonian", TextFormat::DARK_GRAY, 216000);
    }
    ...
    public function getColoredName(): string {
        return TextFormat::RESET . TextFormat::DARK_GRAY . "Plutonian" . TextFormat::RESET;
    }
    ...
    public function giveTo(NexusPlayer $player, bool $give = true): array {
        ...
        $items[] = (new Shard($rarity))->toItem()->setCount(mt_rand(5, 10));
        if($give) {
