...
class Majesty extends Kit {

    /**
     * Archer constructor.
     */
    public function __construct() {
        parent::__construct("Alien", TextFormat::BLUE, 216000);
    }
    ...
    public function getColoredName(): string {
        return TextFormat::RESET . TextFormat::BOLD . TextFormat::BLUE . "Alien" . TextFormat::RESET;
    }
    ...
    public function giveTo(NexusPlayer $player, bool $give = true): array {
        ...
        foreach($set as $item) {
            ...
            if($item instanceof Sword) {
                ...
                $item->addEnchantment(new EnchantmentInstance(EnchantmentManager::getEnchantment(Enchantment::SWORDSMAN), 1));
                $items[] = $item;
            }
        }
        $rarity = ItemManager::getRarityByLevel($level);
        $items[] = (new Shard($rarity))->toItem()->setCount(mt_rand(25, 30));
        if($give) {
