...
class PrestigePickaxeQuest extends Quest {

    /**
     * PrestigePickaxeQuest constructor.
     *
     * @param string $name
    ...
    public function __construct(string $name, string $description, string $rarity, int $targetValue) {
        $callable = function(PrestigePickaxeEvent $event) {
        ...
        parent::__construct($name, $description, $rarity, self::PRESTIGE_PICKAXE, $targetValue, $callable);
    }
}