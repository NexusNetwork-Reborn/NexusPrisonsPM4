...
class MineMeteoriteQuest extends Quest {
    ...
    public function __construct(string $name, string $description, string $rarity, int $targetValue) {
        ...
        parent::__construct($name, $description, $rarity, self::MINE_METEORITE, $targetValue, $callable);
    }
}