...
class LoseCoinFlipChallenge extends Challenge {
    ...
    public function __construct(int $id, string $rarity) {
        $callable = function(CoinFlipLoseEvent $event, Item $scroll) {
        ...
        $description = "Lose $" . number_format($amount) . "+ from /coinflip";
        parent::__construct($id, $description, $rarity, self::COINFLIP_LOSE, $callable);
    }
}