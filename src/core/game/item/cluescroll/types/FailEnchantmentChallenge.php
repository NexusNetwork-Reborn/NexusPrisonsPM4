...
class FailEnchantmentChallenge extends Challenge {
    ...
    public function __construct(int $id, string $rarity) {
        $callable = function(FailEnchantmentEvent $event, Item $scroll) {
        ...
        $description = "Fail an enchant on a piece of gear";
        parent::__construct($id, $description, $rarity, self::FAIL_ENCHANTMENT, $callable);
    }
}