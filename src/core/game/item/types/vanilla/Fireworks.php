...
class Fireworks extends Item {
    ...
    public function getRandomizedFlightDuration(): int {
        return $this->getFlightDuration() * 20;
    }
    ...
    public function onActivate(Player $player, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector): ItemUseResult {
        $rocket = new FireworksRocket(Location::fromObject($blockReplace->getPosition()->add(0.5, 0, 0.5), $player->getWorld(), lcg_value() * 360, 90), $this);
